...
class CategoryController extends Controller
{
    ...
    {
        return view('admin.content.products.category.index');
    }

    public function create()
    {
        return view('admin.content.products.category.create');
    }
    ...
    public function get_json(Request $request){
        ...
        if (!empty($request->input('search')['value'])) {
            ...
            $query->where('product_category_data.title', 'LIKE',"%{$search}%");
        }
        ...
        $returnArray['recordsTotal'] = !isset($total_records) ? ProductCategory::count() : $total_records;
