    ...
    <div class="col">
        <section class="card">
            <header class="card-header">
                <a href="{{ route('admin.content.products.create') }}" class="btn btn-primary btn-sm">{{ __('Add') }} <i class="fas fa-plus"></i></a>
            </header>
            <div class="card-body">
...
@section('livewire_scripts')
    ...
    <script>
        ...
        window.addEventListener('updatetable', event => {
            $('#datatable-products').DataTable().draw();
        })
    </script>
@endsection
