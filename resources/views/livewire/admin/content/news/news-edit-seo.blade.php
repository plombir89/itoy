                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <textarea wire:model.lazy="news.items.{{ $index }}.keywords" class="form-control" rows="2" data-plugin-maxlength maxlength="255">{{ $item->keywords }}</textarea>
                            </div>
                            <p>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <textarea wire:model.lazy="news.items.{{ $index }}.description" class="form-control" rows="2" data-plugin-maxlength maxlength="255">{{ $item->description }}</textarea>
                            </div>
                            <p>
                                <code>max-length</code> set to 255.
                            </p>
