            ...
            <div class="tabs">
                <ul class="nav nav-tabs">
                    <li class="nav-item active">
                        <a class="nav-link" href="#edit" data-toggle="tab">{{ __('Products edit') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#gallery" data-toggle="tab">{{ __('Gallery') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#seo" data-toggle="tab">{{ __('Seo') }}</a>
                    </li>
                </ul>
                <div class="tab-content pb-0">
                    <div id="edit" class="tab-pane active">
                        <livewire:admin.content.products.edit :product="$product" />
                    </div>
                    <div id="gallery" class="tab-pane">
                        <livewire:admin.content.products.gallery :product="$product" />
                    </div>
                    <div id="seo" class="tab-pane">
                        <livewire:admin.content.products.edit-seo :product="$product" />
                    </div>
                </div>
            </div>
        </div>
