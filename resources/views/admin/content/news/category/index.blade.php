...
@section('breadcrumbs')
    ...
    <li><span>{{ __('News') }}</span></li>
    <li><span>{{ __('Category') }}</span></li>
@endsection

@section('content')

    <livewire:admin.content.news.category.index />
            ...
            <footer class="card-footer">
                <div class="row">
                    <div class="col-md-12 text-right">
                        <button class="btn btn-primary modal-confirm" onClick="window.livewire.emit('removeCategoryItem');">{{ __('Confirm') }}</button>
