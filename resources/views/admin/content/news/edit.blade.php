            ...
            <div class="tabs">
                <ul class="nav nav-tabs">
                    <li class="nav-item active">
                        <a class="nav-link" href="#edit" data-toggle="tab">{{ __('News edit') }}</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content pb-0">
                    <div id="edit" class="tab-pane active">
                        <livewire:admin.content.news.news-edit :news="$news" />
                     </div>
                    <div id="seo" class="tab-pane">
                        <livewire:admin.content.news.news-edit-seo :news="$news" />
                    </div>
                </div>
            </div>
        </div>
