            ...
            <div class="tabs">
                <ul class="nav nav-tabs">
                    <li class="nav-item active">
                        <a class="nav-link" href="#edit" data-toggle="tab">{{ __('Services edit') }}</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content pb-0">
                    <div id="edit" class="tab-pane active">
                        <livewire:admin.content.services.edit :services="$services" />
                     </div>
                    <div id="seo" class="tab-pane">
                        <livewire:admin.content.services.edit-seo :services="$services" />
                    </div>
                </div>
            </div>
        </div>
