...
@section('breadcrumbs')
    ...
    <li><span>{{ __('Advantages') }}</span></li>
@endsection

@section('content')

    <livewire:admin.content.advantages.index />
            ...
            <div class="card-body">
                <div class="modal-wrapper">
                    ...
                    <div class="modal-text">
                        <p class="mb-0">{{ __('Are you sure that you want to delete this advantage item?') }}</p>
                    </div>
                </div>
            </div>
            <footer class="card-footer">
                <div class="row">
                    <div class="col-md-12 text-right">
                        <button class="btn btn-primary modal-confirm" onClick="window.livewire.emit('removeAdvantagesItem');">{{ __('Confirm') }}</button>
