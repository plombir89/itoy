...
$(document).ready(() => {
    ...
    jQuery(".product-list-js .product-layout,.ishispecialblock .product-layout,.latestproduct .product-layout,.ishiproductsblock .product-thumb,.related-product .item").each(function() {
